...
//        map.put("today_pcv_3_dose",submission.getFieldValue("pcv_3_dose_today")!=null ?submission.getFieldValue("pcv_3_dose_today"):"");
        ...
        allCommonsRepository.update("pkhousehold", contentValues, submission.entityId());
        ...
        allTimelines.add(new TimelineEvent(submission.entityId(), "HOUSEHOLDFOLLOWUP", LocalDate.parse(submission.getFieldValue("vaccination_date")), "household followup", json.toString(), null));
    }
}
