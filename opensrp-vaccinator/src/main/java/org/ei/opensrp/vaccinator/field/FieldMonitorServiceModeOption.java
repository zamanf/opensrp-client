 ...
 */
public class FieldMonitorServiceModeOption extends ServiceModeOption {


    public FieldMonitorServiceModeOption(SmartRegisterClientsProvider clientsProvider) {
    ...
    public SecuredNativeSmartRegisterActivity.ClientsHeaderProvider getHeaderProvider() {
        return new SecuredNativeSmartRegisterActivity.ClientsHeaderProvider() {
            ...
            public int[] headerTextResourceIds() {
                return new int[]{
                        R.string.day_month
                        , R.string.month_target, R.string.month_received, R.string.month_used,
