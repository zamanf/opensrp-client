...
import org.ei.opensrp.test.test.TestDateSort;
import org.ei.opensrp.test.test.TestSearchOption;
import org.ei.opensrp.test.test.TestServiceModeOption;
import org.ei.opensrp.test.test.TestSmartClientsProvider;
import org.ei.opensrp.test.test.TestSmartRegisterActivity;
 ...
 */
public class  TestSmartRegisterFragment extends SecuredNativeSmartRegisterFragment {
    ...
    protected SecuredNativeSmartRegisterActivity.DefaultOptionsProvider getDefaultOptionsProvider() {
        return new SecuredNativeSmartRegisterActivity.DefaultOptionsProvider() {
            ...
            public ServiceModeOption serviceMode() {
                 ...
                 return new TestServiceModeOption(clientsProvider());
            }
...
//                        new CommonObjectSort(true,false,true,"age")
    ...
    protected SmartRegisterClientsProvider clientsProvider() {
        if (clientProvider == null) {
            clientProvider = new TestSmartClientsProvider(
    ...
    private DialogOption[] getEditOptions() {
        return ((TestSmartRegisterActivity)getActivity()).getEditOptions();
    }
    ...
    protected void onInitialization() {
        if (controller == null) {
            controller = new CommonPersonObjectController(context.allCommonsRepositoryobjects("ibu"),
                    ...
                    context.personObjectClientsCache(), "name", "ibu", "reg_date",
...
//        checkforNidMissing(view);
    ...
    public void startRegistration() {
        ...
        TestLocationSelectorDialogFragment
                .newInstance((TestSmartRegisterActivity) getActivity(), new EditDialogOptionModel(), context.anmLocationController().get(), "kartu_ibu_registration")
...
//                        currentSearchFilter =
                        setCurrentSearchFilter(new TestSearchOption(cs.toString()));
