    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                startActivity(new Intent(ChildrenDetailActivity.this, ChildrenSmartRegisterActivity.class));
        ...
        if(householdclient.getDetails().get("profilepic")!= null){
            setImagetoHolder(ChildrenDetailActivity.this,householdclient.getDetails().get("profilepic"),householdview, R.mipmap.household_profile_thumb);
        }
    ...
    private class PaginationViewHandler implements View.OnClickListener {
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                ...
                //    startActivity(new Intent(ChildrenDetailActivity.this, ElcoSmartRegisterActivity.class));
                    break;
...
//        view.setImageBitmap(bitmap);
    ...
    public void onBackPressed() {
        finish();
        startActivity(new Intent(this, ChildrenSmartRegisterActivity.class));
        overridePendingTransition(0, 0);
