...
public class ChildrenSmartRegisterActivity extends SecuredNativeSmartRegisterActivity {
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case R.id.profile_info_layout:
                    ChildrenDetailActivity.householdclient = (CommonPersonObjectClient)view.getTag();
                    Intent intent = new Intent(ChildrenSmartRegisterActivity.this,ChildrenDetailActivity.class);
...
//                currentSearchFilter = new ChildSearchOption(cs.toString());
//                clientsAdapter
//                        .refreshList(currentVillageFilter, currentServiceModeOption,
//                                currentSearchFilter, currentSortOption);
//
