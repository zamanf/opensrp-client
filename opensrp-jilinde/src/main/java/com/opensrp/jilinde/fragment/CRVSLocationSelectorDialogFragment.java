 ...
 */
public class CRVSLocationSelectorDialogFragment extends DialogFragment {
    ...
    private CRVSLocationSelectorDialogFragment(SecuredNativeSmartRegisterActivity activity,
    ...
    public static CRVSLocationSelectorDialogFragment newInstance(
            SecuredNativeSmartRegisterActivity activity,
            DialogOptionModel dialogOptionModel,
            String locationJSONString,String formname) {
        return new CRVSLocationSelectorDialogFragment(activity, dialogOptionModel, locationJSONString,formname);
    }
